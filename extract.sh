python demo/top_down_img_demo_with_full.py  \
   ...
   configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/res10_coco_192x192.py    work_dirs/res10_coco_192x192/epoch_100.pth     --img-root .  \
    --img ActionDataset-1125/train/0/C0_P0_walk_3/01_1628591494117_1_485_373.jpg     --out-img-root vis_results
